...
module.exports = {
    ...
    callback: (message, args) => {
        ...
        member.roles.remove('830232694930538497') // Removes Mute Role to User
        if(!member.roles.cache.has('830232694930538497')) return message.reply('User Is Already Unmuted.') // If User Is Already Unmuted.
